...
import LuminosityHighPassShader from '../PostProcessShaders/LuminosityHighPassShader';
...
export default class BloomPass extends RenderingPass {
    ...
    dispose () {
        ...
        let il = this.renderTargetsHorizontal.length;
        let jl = this.renderTargetsVertical.length;
        for ( let i = 0; i < il; i ++ ) {
